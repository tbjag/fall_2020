...
#CART model
C50_class<-C5.0( cancer_data_train_target~.,data=cancer_data_train)
summary(C50_class)
C50_predict<-predict(C50_class,cancer_data_test, type="class") 
#16 wrong
table(cancer_data_test_target, C50_predict)
