...
#CART model
CART_class<-rpart( cancer_data_train_target~.,data=cancer_data_train)
CART_predict<-predict(CART_class,cancer_data_test, type="class") 
#16 wrong
table(cancer_data_test_target, CART_predict)
